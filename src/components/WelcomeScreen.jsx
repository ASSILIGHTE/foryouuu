...
export const WelcomeScreen = ({ onOpen }) => {
  return (
    ...
    >
      ...
      >
        {/* Floating Gift Box / Heart Emblem */}
        <motion.div
          animate={{ y: [0, -10, 0], rotate: [0, 3, -3, 0] }}
          transition={{ duration: 4, repeat: Infinity, ease: 'easeInOut' }}
          className="w-20 h-20 sm:w-24 sm:h-24 rounded-3xl bg-gradient-to-tr from-pink-300 via-rose-200 to-sky-200 flex items-center justify-center shadow-xl shadow-pink-200/60 mb-6 border border-white relative group cursor-pointer"
        >
          <Gift size={44} className="text-pink-600 animate-bounce" />
